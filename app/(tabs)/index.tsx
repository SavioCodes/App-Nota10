    ...
    <ScreenContainer className="px-5 pt-4">
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        <View className="flex-row items-center justify-between mb-6">
          <View>
            <Text className="text-base text-muted">Ola,</Text>
        ...
        {usage && usage.plan === "free" && (
          <View className="bg-surface rounded-2xl p-4 mb-5 border border-border">
            <View className="flex-row items-center justify-between mb-2">
              <Text className="text-sm text-muted">Conversoes hoje</Text>
            ...
            <View className="h-2 bg-border rounded-full overflow-hidden">
              <View
                style={[
                  styles.progressBar,
                  {
                    width: `${Math.min(100, (usage.conversionsUsed / usage.conversionsLimit) * 100)}%`,
                    backgroundColor:
                      usage.conversionsUsed >= usage.conversionsLimit ? colors.error : colors.primary,
                  },
                ]}
              />
            </View>
        ...
        <Text className="text-lg font-semibold text-foreground mb-3">Acoes</Text>
